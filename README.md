...
## [Live Demo](https://gustav72.github.io/gif-generator/)
...
This simple project utilizes the Giphy API to search for gifs with a free API key. I added a catch to end of promise chain to notify user of errors with the error.gif
